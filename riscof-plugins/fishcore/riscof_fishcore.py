...
class fishcore(pluginTemplate):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.dut_exe = os.path.join(
            ...
            "/home/leesum/workhome/riscof-test/Vtop",
        )
    ...
    def initialise(self, suite, work_dir, archtest_env):
        ...
        # runTests function
        self.objdump_cmd = "riscv{1}-none-elf-objdump -D {0} > {2};"
        self.objcopy_cmd = "riscv{1}-none-elf-objcopy -O binary {0}  {2}"
        self.compile_cmd = (
            "riscv{1}-none-elf-gcc -march={0} \
    ...
    def build(self, isa_yaml, platform_yaml):
        ...
        # for fishcore start building the '--isa' argument. the self.isa is dutnmae specific and may not be
        # useful for all DUTs
    ...
    def runTests(self, testList):
        ...
        for testname in testList:
            ...
            compile_isa = testentry["isa"].lower()
            if(compile_isa.find("_zifencei") == -1):
                compile_isa = compile_isa + "_zifencei"
            ...
            cmd = self.compile_cmd.format(
                compile_isa, self.xlen, test, elf, compile_macros
            )
            print(cmd)
            ...
            if self.target_run:
                ...
                simcmd = (
                    self.dut_exe
                    + " --file={0} --signature={1} --tohost-check  --clk=1000000".format(
